...
export class Backend implements backendInterface {
    ...
    async createRide(arg0: string, arg1: string, arg2: number, arg3: bigint, arg4: string, arg5: bigint): Promise<Ride> {
        if (this.processError) {
            try {
                const result = await this.actor.createRide(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteRide(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteRide(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRide(arg0: bigint): Promise<Ride> {
        if (this.processError) {
            try {
    ...
    async updateRide(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: bigint, arg5: string, arg6: bigint): Promise<Ride> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRide(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
